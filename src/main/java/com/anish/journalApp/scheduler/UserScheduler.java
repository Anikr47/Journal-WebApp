...
import com.anish.journalApp.service.MailService;
    ...
    public void fetchUserAndSendMail(){
        ...
        for(User user : users){
            ...
            List<Sentiment> sentiments = journalEntries.stream().
                    ...
                    collect(Collectors.toList()); // fetching sentiments of last 7 days of an user
            Map<Sentiment, Integer> sentimentCounts = new HashMap<>();
            for(Sentiment sentiment : sentiments){
                if(sentiment!=null){
                    sentimentCounts.put(sentiment, sentimentCounts.getOrDefault(sentiment, 0)+1);
                }
                Sentiment mostFrequentSentiment = null; // calculating most frequent count of a sentiment
                int maxCount =0;
